...
Tanggal Pinjam (YYYY-MM-DD) : ' . $_overdue['loan_date'] . '
Tanggal kembali (YYYY-MM-DD): ' . $_overdue['due_date'] .'
...
';
        ...
        $message= 'Hallo, *'.$this->member_name.'* - ID Anggota : '.$this->member_id.'
...
*'.$sysconf['library_name'].'*';
        ...
        $data = array(
            'device_id' => '8f23fc8d38a68f094254586470cb758d',
            'number' => $this->member_phone,
            'message' => $message,
        );
        $payload = $data;
